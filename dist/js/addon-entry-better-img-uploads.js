...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  while (true) {
    ...
    const _createItem = createItem(id, isRight),
      _createItem2 = _slicedToArray(_createItem, 4),
      menuItem = _createItem2[0],
      hdButton = _createItem2[1],
      input = _createItem2[2],
      tooltip = _createItem2[3];
