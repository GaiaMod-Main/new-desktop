    ...
    const doShear = (skx, sky) => {
      ...
      if (!this.skewCenter) {
        switch (this._getRectCornerNameByIndex(this.index)) {
          case 'topCenter':
          case 'leftCenter':
            offcenterPosition = this.itemGroup.position.add(new paper.Point(skewBounds.width / 2, skewBounds.height / 2));
            break;
          case 'bottomCenter':
          case 'rightCenter':
            offcenterPosition = this.itemGroup.position.subtract(new paper.Point(skewBounds.width / 2, skewBounds.height / 2));
            break;
        }
      }
